...
export const ORDER_OWN_LIST_REQUEST = 'ORDER_OWN_LIST_REQUEST'
export const ORDER_OWN_LIST_SUCCESS = 'ORDER_OWN_LIST_SUCCESS' 
export const ORDER_OWN_LIST_FAIL = 'ORDER_OWN_LIST_FAIL'
export const ORDER_OWN_LIST_RESET = 'ORDER_OWN_LIST_RESET'
